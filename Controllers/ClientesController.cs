...
namespace Distribuidora.Controllers
{
    ...
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CUIT,RazonSocial,Email,Telefono,DireccionEnvio")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CUIT,RazonSocial,Email,Telefono,DireccionEnvio")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
